import projectOne from '../assets/mood-flix.jpg';
import projectTwo from '../assets/art-garage.jpg';
import projectThree from '../assets/weather-bee.jpg';
import projectFour from '../assets/mercedes-binge.jpg';
import projectFive from '../assets/krafty-recipes.jpg';
...
const ProjectCardData = [
  ...
  },
  {
    ...
    title: 'Krafty Recipes',
    text: "Who does't love Kraft cheese? In this app you'll be able to search through hundreds of recepes that use Kraft cheese. There are also photos is case you want to drool over cheese dishes while at work. come inside and take a look.",
    website: '/',
    git: '/',
    enternal: true
  }
